...
def get_dataset(args):
    if args.dataset == "ag_news":
        ...
        train_dataset = datasets.load_dataset("/mnt/data/peiyu.liu/bak_data3/data_home/dataset/ag_news/default/0.0.0/1f9a99ab0baf57c5")["train"]
        test_dataset = datasets.load_dataset("/mnt/data/peiyu.liu/bak_data3/data_home/dataset/ag_news/default/0.0.0/1f9a99ab0baf57c5")["test"]
