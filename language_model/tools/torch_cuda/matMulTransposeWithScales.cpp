...
void torch_launchmatMulTransposeWithScalesCublas(
    ...
    launchmatMulTransposeWithScalesCublas((const __half *)A.data_ptr(), 
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("torch_launchmatMulTransposeWithScalesCublas",
    &torch_launchmatMulTransposeWithScalesCublas, 
    "Matrix multiplication with scales kernel launch with cublas");
}
